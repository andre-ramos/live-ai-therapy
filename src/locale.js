const CATALOGS = Object.freeze({
  "pt-BR": {
    ...
    settings: "Configurações", clearHistory: "Apagar histórico", clearHistoryTitle: "Apagar todo o histórico", clearHistoryBody: "Isso encerrará a sessão atual, apagará conversas, memórias e resumos e fará Sandy recomeçar do zero.", clearHistoryConfirm: "Apagar tudo e recomeçar", clearHistoryCancel: "Voltar", clearHistoryProcessing: "Apagando histórico…", clearHistoryError: "Não foi possível apagar o histórico agora. Tente novamente.", sessionTopics: "Tópicos da sessão", moveTopics: "Mover painel de tópicos com o mouse, toque ou teclas de seta",
    ...
    sessionStage: "Sessão com {name}", retry: "Tentar novamente", completedMessage: "Esperamos que este tempo tenha sido acolhedor e proveitoso para você.", cancelledMessage: "Você pode recomeçar quando se sentir confortável.", userEndedMessage: "Encerramos por aqui como você pediu. Você pode voltar quando quiser.", silenceEndedMessage: "A sessão foi encerrada após um período sem áudio. Quando quiser continuar, é só começar outra sessão.",
    ...
    secureMicrophone: "O microfone exige uma conexão HTTPS segura.", unsupportedCapture: "Este navegador não oferece captura de voz compatível.", idleWarning: "{name} ainda está aqui com você. Se quiser, podemos continuar.", themeLight: "claro", themeDark: "escuro", switchTheme: "Mudar para tema {theme}", themeTitle: "Tema {theme}",
  },
  "en-US": {
    ...
    microphone: "Microphone", micEnable: "Enable microphone", micDisable: "Disable microphone", micLocked: "Microphone locked while {name} responds", waitForVoice: "Wait for {name} to finish", settings: "Settings", clearHistory: "Clear history", clearHistoryTitle: "Clear all history", clearHistoryBody: "This will end the current session, erase conversations, memories, and summaries, and make Sandy start from zero.", clearHistoryConfirm: "Erase everything and restart", clearHistoryCancel: "Go back", clearHistoryProcessing: "Clearing history…", clearHistoryError: "Could not clear history right now. Try again.", 
    ...
    sessionStage: "Session with {name}", retry: "Try again", completedMessage: "We hope this time felt supportive and useful.", cancelledMessage: "You can begin again when you feel comfortable.", userEndedMessage: "We stopped here as you asked. You can come back whenever you want.", silenceEndedMessage: "The session ended after a period with no audio. When you want to continue, start a new session.", completedTopics: "Completed topics",
    ...
    playbackFailed: "Could not play the voice response.", secureMicrophone: "The microphone requires a secure HTTPS connection.", unsupportedCapture: "This browser does not support compatible voice capture.", idleWarning: "{name} is still here with you. If you want, we can keep going.", themeLight: "light", themeDark: "dark", switchTheme: "Switch to {theme} theme", themeTitle: "{theme} theme",
  },
});
